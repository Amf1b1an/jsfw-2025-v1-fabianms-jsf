...
function CatalogueContent() {
  ...
  if (loading)
    return (
      <p className="p-10 text-center font-bold text-sky-950">
        Loading Catalogue...
      </p>
    );
      ...
      {sortedProducts.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 p-8">
          {sortedProducts.map((product) => (
            <div
              key={product.id}
              className="border-4 border-sky-950 p-6 shadow-[8px_8px_0px_0px_rgba(8,145,178,1)] bg-sky-950 text-mist-300 flex flex-col"
            >
              <img
              ...
              <Link
                ...
                className="mt-auto self-center text-center bg-mist-300 text-sky-950 font-black p-3 border-2 border-sky-950 hover:bg-cyan-500 transition uppercase text-sm"
              >
